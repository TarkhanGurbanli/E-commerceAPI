...
namespace EcommerceApi.Core.Utilities.MailHelper
{
    public class EmailHelper : IEmailHelper
    {
        public bool SendEmail(string mailAddress, string token, bool bodyHtml)
        {
            ...
            try
            {
                ...
                mailMessage.Body = $"<a href='https://localhost:7090/api/auth/verifypassword?email={mailAddress}&token={token}'>Tesdiq et</a>";
